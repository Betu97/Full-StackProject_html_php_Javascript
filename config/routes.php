...
use SallePW\SlimApp\Controller\UploadImageController;
use SallePW\SlimApp\Controller\SignOutController;
use SallePW\SlimApp\Controller\UpdateItemController;
...
$app
    ->post('/image', UploadImageController::class . ':uploadAction')
    ->setName('image');
$app
    ->get('/delete', DeleteAccountController::class . ':deleteAction')
    ->setName('delete');
...
$app->get('/signOut', SignOutController::class . ':signOutAction')
    ->setName('signOut');
...
$app
    ->post('/updateItem', UpdateItemController::class . ':updateItem')
    ->setName('updateItem');
